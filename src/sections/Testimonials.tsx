        ...
        <div className='flex gap-5'>
          {
            testimonials.map((testimonial, index) => (
              <div key={index} className='border border-white/15 p-6 md:p-10 rounded-xl bg-[linear-gradient(to_bottom_left,rgb(140,69,255,0.3),black)] max-w-xs md:max-w-md flex-none  ' >
